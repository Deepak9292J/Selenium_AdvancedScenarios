...
public class Multiplechildwindowstest {
	...
	public static void main(String[] args) {
		...
		for(int i=1 ; i<count ; i++)
		{
			...
			Iterator<String> handleID = ids.iterator();
			while(handleID.hasNext())
			{
				driver.switchTo().window(handleID.next());
